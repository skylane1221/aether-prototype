...
export const ImpactPage: React.FC = () => {
  ...
  return (
    <div className="space-y-16 sm:space-y-24 pb-16">
      <SEO
        title="Business Impact & ROI Analysis | Aether"
        description="Quantify measurable operational efficiency gains, throughput improvements, and projected return on investment with Aether."
