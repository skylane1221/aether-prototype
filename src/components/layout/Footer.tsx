...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-aether-border bg-aether-surface/60 text-text-secondary relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-px bg-gradient-to-r from-transparent via-aether-clay/20 to-transparent" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 mb-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center gap-2.5 group inline-flex select-none">
              <div className="w-7 h-7 rounded-lg bg-aether-cocoa text-[#FAF6F0] border border-aether-cocoa flex items-center justify-center shadow-sm">
                <Layers className="w-4 h-4 text-aether-yellow" />
              </div>
            ...
            <div className="pt-2 flex items-center gap-3">
              <Badge variant="neutral" size="sm" dot dotColor="bg-aether-success">
        ...
        <div className="mb-8 p-4 rounded-xl bg-aether-card border border-aether-border flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-text-muted">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-aether-yellow shrink-0" />
        ...
        <div className="pt-8 border-t border-aether-border-subtle flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-text-muted">
          ...
          <div className="flex items-center gap-6">
            <span className="flex items-center gap-1.5">
              <ShieldCheck className="w-3.5 h-3.5 text-aether-success" />
              <span>Zero Production Data Dependencies</span>
            </span>
            <span className="flex items-center gap-1.5">
              <Activity className="w-3.5 h-3.5 text-aether-clay" />
