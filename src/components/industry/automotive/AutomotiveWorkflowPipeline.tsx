...
const AUTOMOTIVE_STAGES: AutomotiveStageDetail[] = [
  {
    ...
    icon: Car,
    traditionalPain:
      'Fragmented paper service books, unrecorded aftermarket modifications, and unknown vehicle maintenance baselines.',
    aetherIntelligence:
      'Unified digital vehicle passport compiling telematics, odometer telemetry, OEM technical service bulletins, and full repair history.',
    dataPoints: [
      'Live Odometer & Telematics Feed',
      'OBD-II Fault History (DTC Log)',
      'OEM Service Interval Matrix',
      'Factory Warranty & Recall Status',
    ],
  ...
  },
  {
    ...
    icon: FileText,
    traditionalPain:
      'Previous repair notes scattered across disconnected dealer software; repeated unnecessary diagnostic labor.',
    aetherIntelligence:
      'Intelligent multi-visit component wear modeling calculating exact degradation rates for brake pads, rotors, filters, and fluids.',
    dataPoints: [
      'Prior Repair Order Line Items',
      'Component Replacement Timestamps',
      'Technician Diagnostic Annotations',
      'Fleet Vehicle Wear Variance',
    ],
  ...
  },
  {
    ...
    icon: Wrench,
    traditionalPain:
      'Unanticipated component failures and emergency roadside breakdowns that frustrate vehicle owners.',
    aetherIntelligence:
      'Predictive maintenance engine forecasting exact mileage milestones (30k/60k/90k) and flagging upcoming preventative replacements.',
    dataPoints: [
      'Brake Pad Lining Remaining (3mm)',
      'Transmission Fluid Viscosity Curve',
      'Tire Tread Depth Telemetry',
      'Seasonal Battery Health Metric',
    ],
  ...
  },
  {
    ...
    icon: Bell,
    traditionalPain:
      'Generic postcard reminders sent months too late; customers switch to independent quick-lube chains.',
    aetherIntelligence:
      'Contextual WhatsApp/SMS alerts timed to exact vehicle mileage with transparent line-item estimates and 1-tap bay booking.',
    dataPoints: [
      'Odometer Projection Algorithm',
      'Pre-Calculated Job Estimate ($)',
      'Preferred Customer Drop-off Day',
      '1-Tap Digital Booking Token',
    ],
  ...
  },
  {
    ...
    icon: Calendar,
    traditionalPain:
      'Advisors double-book morning drop-offs; customers wait in service lane queues while paperwork is manually typed.',
    aetherIntelligence:
      'Dynamic intake slot reservation matching customer arrival times with certified technician availability and loaner fleet schedules.',
    dataPoints: [
      'Estimated Labor Duration (2.5 hrs)',
      'Express vs Heavy Bay Allocation',
      'Customer Mobility / Loaner Pass',
      'Digital Drop-Off Check-In Pass',
    ],
  ...
  },
  {
    ...
    icon: Cpu,
    traditionalPain:
      'Cars put on lifts before parts arrive; master technicians bottlenecked while express bays sit empty.',
    aetherIntelligence:
      'Autonomous bay-and-parts orchestration verifying warehouse stock and routing repair orders to certified master techs.',
    dataPoints: [
      'Lift Bay Capacity Status (Bay 4 Held)',
      'Parts Counter Pre-Staging Scan',
      'Master Tech Skill Certification',
      'Live Tablet RO Job Timer',
    ],
  ...
  },
  {
    ...
    icon: HeartHandshake,
    traditionalPain:
      'Customers feel overcharged due to opaque repair advice; low post-warranty dealership retention.',
    aetherIntelligence:
      'Transparent multi-point video inspection approvals, post-service digital health cards, and automated loyalty tier perks.',
    dataPoints: [
      'Video Inspection Approval Rate (88%)',
      'Customer Satisfaction (CSAT 4.9/5)',
      '12-Month Vehicle RO Trajectory',
...
export const AutomotiveWorkflowPipeline: React.FC = () => {
  ...
  const currentStage =
    AUTOMOTIVE_STAGES.find((s) => s.id === activeStageId) || AUTOMOTIVE_STAGES[0];
                  ...
                  <div
                    className={`p-1.5 rounded-lg transition-colors ${
                      isSelected
                        ...
                        : 'bg-white/5 text-zinc-400 group-hover:text-indigo-400'
                    }`}
                  >
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      <Badge
                        variant="primary"
                        size="sm"
                        className="text-[10px] bg-indigo-500/20 text-indigo-300 border-indigo-500/40"
                      >
