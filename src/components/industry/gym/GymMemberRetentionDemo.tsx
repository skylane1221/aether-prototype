    ...
    <div className="space-y-8">
      ...
      <Card className="p-0 border-emerald-900/60 overflow-hidden shadow-2xl bg-slate-950">
        ...
        <div className="p-6 sm:p-8 space-y-8">
          {/* 1. Member Selector Grid */}
          <div className="space-y-3">
            <div className="flex items-center justify-between pb-1">
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                <h4 className="text-xs font-semibold text-text-primary uppercase tracking-wider">
                  1. Select a Simulated Member Profile:
                </h4>
              </div>
              <span className="text-[11px] font-mono text-text-muted">4 Distinct Risk Archetypes</span>
            </div>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-xs font-mono">
                    <span className="text-text-muted font-sans font-semibold flex items-center gap-1.5">
                      ...
                      8-Week Turnstile Attendance Curve
                    </span>
            ...
            <div className="lg:col-span-5 space-y-4">
              <Card className="p-5 bg-slate-900/90 border-emerald-900/40 space-y-4 flex flex-col justify-between h-full">
                <div className="space-y-3">
                  ...
                  {/* Recommended Action */}
                  <div className="p-3 rounded-lg bg-emerald-950/30 border border-emerald-500/30 text-xs text-slate-200 space-y-1">
