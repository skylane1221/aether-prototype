...
export const PLATFORM_IMPACT_METRICS: PlatformImpactMetric[] = [
  {
    ...
    summary: 'Example scenario: 8–15 administrative hours potentially recovered weekly per operational team member.',
  },
  {
    id: 'efficiency',
    ...
    summary: 'Illustrative modeling: Direct expansion of billable operational capacity in high-utilization environments.',
  },
  {
  ...
  },
  {
    ...
    subtext: 'Automatically contacts standby queues to backfill last-minute cancellations, preserving high-margin slots.',
  ...
  },
  {
    ...
    subtext: 'Models customer surge patterns, weather shifts, and inventory burn rates ahead of time, reducing guesswork.',
